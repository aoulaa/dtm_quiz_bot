...
async def on_startup(dispatcher):
    ...
    # await commands.add_user(312231231, 'olim', 'eq', 1322231)
    # await commands.add_user(3122231231, 'olim1', 'eq', 1325231)
    # await commands.add_user(3122313231, 'olim2', 'eq', 1324231)
    # await commands.add_user(3122321231, 'olim2', 'eq', 1322313)
    # await commands.add_user(3122351231, 'olim3', 'eq', 1325231)
    # await commands.add_user(3122314231, 'olim4', 'eq', 13223231)
    # await commands.add_user(3122351231, 'olim5', 'eq', 1325231)
